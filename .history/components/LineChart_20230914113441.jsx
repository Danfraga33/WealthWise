...
const LineChart = ({ portfolioData }) => {
	...
	async function getTimeSeriesData() {
		...
		const url =
			'https://api.twelvedata.com/time_series?apikey=8860a0a8a2534090a4b0a9423e2d9cce&interval=1day&start_date=2010-01-01 00:00:00&type=stock&country=US&exchange=NASDAQ&symbol=AAPL&previous_close=true&format=JSON';
