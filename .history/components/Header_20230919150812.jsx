...
const Header = () => {
	...
	return (
		<header class="w-full mt-5 text-gray-700 bg-white shadow body-font bg-opacity-100 h-full">
			<div class="flex justify-between container items-start p-2 mx-auto md:flex-row">
