...
const LineChart = ({ portfolioData }) => {
	...
	async function getTimeSeriesData() {
		...
		const url =
			'https://api.twelvedata.com/time_series?apikey=8860a0a8a2534090a4b0a9423e2d9cce&symbol=AAPL&interval=1week&country=US&exchange=NASDAQ&type=etf&start_date=2000-01-01 00:00:00&format=json';
