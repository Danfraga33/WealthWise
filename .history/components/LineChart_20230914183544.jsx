...
const LineChart = ({ portfolioData }) => {
	...
	function findNearestFriday(inputDate) {
	 ...
	 // Example usage:
	 const inputDate = '2013-01-15';
	 const nearestFriday = findNearestFriday(inputDate);
	 console.log(nearestFriday); // Output: '2013-01-18' (Friday)
	 This function first determines the current day of the week for the given date, then calculates the number of days to add to reach the nearest Friday (either counting forward or backward), and finally returns the nearest Friday date in 'YYYY-MM-DD' format.
	...
	const startingPoint = earliestDate;
