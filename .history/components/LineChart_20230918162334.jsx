				...
				const updatedWeeklyPricedDatesWithClose = [
					{
						...{
							...
							ticker: portfolioData[0].ticker,
							position: portfolioData[0].positionSize,
						},
						...weeklyPriceDateswithClose[0],
					},
					{
						...{
							id: portfolioData[1].id,
							ticker: portfolioData[1].ticker,
							position: portfolioData[1].positionSize,
						},
						...weeklyPriceDateswithClose[1],
					},
				];
