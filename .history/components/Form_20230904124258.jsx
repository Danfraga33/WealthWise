...
const Form = () => {
	...
	function submitHandler(event) {
		...
		const enteredName = imageInputRef.current.value;
		const enteredPositionSize = addressInputRef.current.value;
      const enteredavgPurchasePrice = descriptionInputRef.current.value;
      const enteredvalueAtPurchase = 
