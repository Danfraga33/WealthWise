	...
	async function getTimeSeriesData(ticker) {
		...
		try {
			...
			if (response.ok) {
				...
				const earliestDate = findEarliestDate(datesArr); // You already have this
				const latestDate = findLatestDate(datesArr); // You need to implement a function to find the latest date
