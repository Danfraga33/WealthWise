		...
		try {
			...
			if (response.ok) {
				...
				function calculateCompoundInterest(
					...
					if (initialAmount >= targetAmount || expectedInterestRate <= 0) {
						return [];
					}

					const weeklyInterestRate = expectedInterestRate / 52; // Assuming 52 weeks in a year
				...
				// Example usage:
				const initialAmount = initialAmount; // Initial amount in dollars
				const targetAmount = targetAmount; // Target amount in dollars
				const expectedInterestRate = annualGrowthRate; // Expected annual interest rate (5%)
