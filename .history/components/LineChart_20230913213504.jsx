...
const LineChart = ({ portfolioData }) => {
	...
	function handleTargetChange() {
		const newInitialAmount = initialAmountRef.current.value;
		const newTargetAmount = targetInputRef.current.value;
		const newGrowthRate = annualGrowthRateRef.current.value;
