...
const Header = () => {
	...
	return (
		<header class="w-full  text-gray-700 bg-white shadow body-font ">
			<div class="container items-start p-3 mx-auto md:flex-row flex justify-between ml-1">
				<a class="flex items-center justify-center mb-1 font-medium text-gray-900 title-font md:mb-0 ">
					<Image height={25} width={25} src="/search.svg" />
					<h1 className="ml-1">WealthWave Navigator</h1>
					{/* <svg
