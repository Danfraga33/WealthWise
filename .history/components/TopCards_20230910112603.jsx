	...
	return (
		<Fragment>
			<div className="grid lg:grid-cols-9 gap-4 p-4">
				<div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full p-4 rounded-lg shadow-lg">
				...
				<div className="lg:col-span-2 col-span-1 bg-white flex justify-between p-4 w-full rounded-lg shadow-lg">
					<div className="flex flex-col w-full pb-4">
				...
				<div className=" lg:col-span-2 bg-white flex justify-between w-full p-4 rounded-lg shadow-lg">
					<div className="flex flex-col w-full pb-4">
				...
				<div className="lg:col-span-3 col-span-1 bg-white flex justify-between w-full p-4 rounded-lg shadow-lg">
					<div className="flex flex-col w-full pb-4">
