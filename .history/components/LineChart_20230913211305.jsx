...
const LineChart = ({ portfolioData }) => {
	...
	const enteredInitialAmount = initialAmountRef.current.value;
	const enteredTargetInput = targetInputRef.current.value;
	const enteredGrowthRate = annualGrowthRateRef.current.value;
	function handleTargetChange() {
		console.log(typeof +enteredTargetInput);
		initialAmount = enteredInitialAmount;
		targetAmount = enteredTargetInput;
		annualGrowthRate = enteredGrowthRate;
	}
			...
			<div className="w-full md:col-span-2 relative lg:h-[7-vh] h-[70vh] m-auto p-4 border rounded-lg bg-white shadow-lg">
				<div className="grid grid-cols-3 gap-">
					...
					<div className="md:flex md:flex-col text-center">
						...
						<button onClick={handleTargetChange}> HELO</button>
