...
const LineChart = ({ portfolioData }) => {
	...
	async function getTimeSeriesData() {
		// f6dd4dd812a298ca21850b169713d683;

		const url =
			'https://api.polygon.io/v2/aggs/ticker/BHP/range/1/week/1990-01-01/2023-01-09?adjusted=true&sort=asc&limit=5000&apiKey=WsJDp42rPMioim4r9xtNIK3GLoRpi1z5';
		const params = { access_key: 'f6dd4dd812a298ca21850b169713d683' };
		try {
