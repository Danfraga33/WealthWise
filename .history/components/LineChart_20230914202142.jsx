...
const LineChart = ({ portfolioData }) => {
	...
	const earliestDate101 = findNearestFriday(portfolioData[0].dateOfPurchase);
	const earliestDate102 = findNearestFriday(earliestDate101);
	console.log(earliestDate102);
	console.log(dates);
	const starting = findNearestFriday(earliestDate102);

	// // Find the index of the earliestDate in the dates array
	// const startIndex = dates.indexOf(earliestDate101);
