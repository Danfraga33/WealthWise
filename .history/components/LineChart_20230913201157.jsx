...
const LineChart = ({ portfolioData }) => {
	...
	datesData.forEach((stock) => console.log(stock.dateOfPurchase));
	if (datesData.length > 0) {
		const firstDate = datesData;
		dates.push(firstDate.dateOfPurchase); // Outputs the first date without it being in an array
	} else {
		console.log('No dates found in the portfolioData array.');
	}
	console.log(dates);
