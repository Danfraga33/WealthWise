...
const LineChart = ({ portfolioData }) => {
	...
	async function getTimeSeriesData() {
		const url =
			'https://api.polygon.io/v2/aggs/ticker/AAPL/range/100/week/2000-01-01/2023-01-09?adjusted=true&sort=asc&limit=5000&apiKey=WsJDp42rPMioim4r9xtNIK3GLoRpi1z5';
		try {
