...
const Header = () => {
	...
	return (
		<header class="w-full mt-5 text-gray-700 bg-white shadow body-font bg-opacity-100">
			<div class="flex justify-between container items-start p-2 mx-auto md:flex-row h-full">
				<a class="flex items-center mb-4 font-medium text-gray-900 title-font md:mb-0 h-full">
					<svg
