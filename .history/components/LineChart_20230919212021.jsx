		...
		try {
			...
			if (response.ok) {
				...
				for (let i = 0; i < numberOfYearsToAdd * 52; i++) {
					const lastDate = attempt[dates.length - 1];
				...
				// Example usage:
				const mom = 35000; // Initial amount in dollars
				const dad = 500000; // Target amount in dollars
				const expectedTimeFrameInYears = 20; // Expected time frame in years
