...
const LineChart = ({ portfolioData }) => {
	...
	//////////////////////////////////////////////////////////
	////// NETWORTH
	const correctedTimeSeriesData = extractFromPointToEnd(
		timeSeriesData,
		startingPoint
	);
	const correctPriceData = Object.keys(correctedTimeSeriesData).map((date) => {
		const closePrice1 = parseFloat(correctedTimeSeriesData[date]['4. close']);
		setUserMarketValues(correctPriceData);
