				...
				<div className="grid grid-cols-3 gap-">
					...
					<div className="md:flex md:flex-col text-center">
						...
						<Link href="/questionnaire">
							<button className="px-2 py-1 bg-blue-500 hover:bg-blue-600 text-white italic font-semibold rounded-md shadow-md text-sm">
								Need Help ?
							</button>
						</Link>
					</div>
					<div className="md:flex md:flex-col text-center">
						...
						<div>
							<input
								...
								type="number"
								placeholder="10%"
								className="text-center border border-blue-200 p-1 outline-none"
							/>
							<span>%</span>
						</div>
					</div>
