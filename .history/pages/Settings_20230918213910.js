			...
			<div className="bg-gray-100 min-h-screen">
				<div className="items-center p-5">
					<div>
						...
						<div className="w-full ">
							<button
								className="pt-1 pb-1 pr-3 pl-3 border border-gray-700 rounded-lg hover:bg-gray-100 mt-2 hover:bg-white"
					...
					<div className="flex items-centermt-10">
						<button className='className="flex justify-center items-center pt-1 pb-1 pr-2 border border-gray-700 rounded-lg hover:bg-white'>
							Give Feedback
						</button>
						<div className="flex items-center mt-2">
							<button
								className="flex justify-center items-center pt-1 pb-1 pr-2 border border-gray-700 rounded-lg hover:bg-white "
								onClick={() => signOut()}
							>
