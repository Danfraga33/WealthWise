					...
					<form onSubmit={submitHandler}>
						...
						>
							...
							{suggestions.length > 0 && (
								<ul className="absolute bg-white border border-gray-300 mt-8 w-[90%] rounded-lg shadow-lg z-10 h-full overflow-hidden">
									{suggestions.map((suggestion) => (
										<li
											key={suggestion.ticker}
											className="text-sm p-1 overflow-scroll cursor-pointer hover:bg-gray-100"
											onClick={() => {
