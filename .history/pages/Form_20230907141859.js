...
const Form = (props) => {
	...
	async function submitHandler(event) {
		...
		const currentValue = Number(enteredPositionSize * enteredLastPrice);
		const initialValue = Number(enteredPositionSize * enteredavgPurchasePrice);
		const marketValue = Number(enteredLastPrice * enteredPositionSize);
