...
const settings = () => {
	...
	function updateStates() {
		const newGrowthRate = initialAmountRef.current.value;
		const newInitialAmount = targetInputRef.current.value;
		const newTargetAmount = annualGrowthRateRef.current.value;
