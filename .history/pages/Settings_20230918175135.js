			...
			<div className="bg-gray-100 min-h-screen">
				<div className="flex justify-center items-center p-5">
					<div className="bg-white rounded-lg p-3 w-3/4">
						...
						<div className="mt-10">
							<button className='className="flex justify-center items-center pt-1 pb-1 pr-1 border border-gray-700  rounded-lg hover:bg-gray-100'>
								Give Feedback
							</button>
							<div className="flex items-center mt-2">
								<button
									className="flex justify-center items-center pt-1 pb-1 pr-1 border border-gray-700  rounded-lg hover:bg-gray-100 "
									onClick={() => signOut()}
								>
