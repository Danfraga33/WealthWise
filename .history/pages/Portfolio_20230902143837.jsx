		...
		<div className="bg-gray-100 min-h-screen">
			...
			<div className="p-4">
				<div className="w-full border m-auto p-4 rounded-lg bg-white overflow-y-auto">
					<div className="my-3 p-2 grid md:grid-cols-9 sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer">
						<span>Status</span>
						...
						<span className="hidden sm:grid">Performance Since Inception</span>
					</div>
					<ul>
						{data.map((stock, id) => (
							<li
								key={id}
								className="bg-gray-50 hover:bg-gray-100 rounded-lg my-3 p-2 grid md:grid-cols-9 sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer"
							>
								<div className="flex">
									<div
										className={
									...
									<div className="pl-4">
										...
										<p className="text-gray-800 text-sm">{stock.lastPrice}</p>
									</div>
								</div>
								<div className="flex">
									<div
								...
								<p className="hidden md:flex">{stock.purchasePrice}</p>
