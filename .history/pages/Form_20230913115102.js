...
const Form = () => {
	...
	useEffect(() => {
		const fetchAlphaData = async () => {
			const url = `https://api.polygon.io/v2/aggs/ticker/https://api.polygon.io/v1/open-close/AAPL/2023-07-04?adjusted=true&apiKey=WsJDp42rPMioim4r9xtNIK3GLoRpi1z5/range/1/day/2023-01-09/2023-01-09?apiKey=WsJDp42rPMioim4r9xtNIK3GLoRpi1z5`;
