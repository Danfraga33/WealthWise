								...
								{currentQuiz < quizData.length ? (
									...
									<div className="quiz-result">
										<p className="text-center font-semibold text-xl text-blue-700">
											...
											lifestyle, let's keep it simple. <br />
											There are companies out there that pay you cash
											periodically within the year. If you save ${score}, and
											invest in these companies, paying you about 5% of this
											amount, you would get get paid ${score * 0.05} each year
											passively, making this amazing lifestyle of yours easily
											obtainable. That way, you can enjoy your retirement
											worry-free and with a big smile!`
										</p>
										<div className="pt-2  ">
