								...
								{currentQuiz < quizData.length ? (
									...
									<div className="quiz-result">
										<p className="text-center font-semibold text-xl text-blue-700">
											...
											you save ${score}, and invest in these companies, giving
											you about 5% of this you would have ${score * 0.05} each
											year passively. That way, you can enjoy your retirement
