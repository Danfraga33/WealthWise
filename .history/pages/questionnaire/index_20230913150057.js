								...
								{currentQuiz < quizData.length ? (
									...
									<div className="quiz-result">
										<p className="text-center font-semibold text-xl text-blue-700">
											...
											There are companies out there that pay you throughout the
											year. If you save ${score}, and invest in these companies,
											paying you about 5% of this amount, you would get get paid
											${score * 0.05} each year passively, making this amazing
											lifestyle of yours easily obtainable.</br> That way, you can
