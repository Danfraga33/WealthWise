...
const Form = () => {
	...
	const handleStockSelection = (selectedStock) => {
		if (selectedStock) {
			setChosenStock(selectedStock);
			const lastPrice = selectedStock.c; // Get the "c" property
			lastPriceInputRef.current.value = lastPrice; // Set the "Last Price" input
		}
		setSuggestions([]); // Clear suggestions
	};
	const lastestPrice = chosenStock.c;
	console.log(typeof chosenStock.c);
										...
										{suggestions.map((suggestion) => (
											<li
												...
												onClick={() => {
													...
													lastPriceInputRef.current.value = lastestPrice;
													setChosenStock(null);
