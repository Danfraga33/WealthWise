...
const Form = () => {
	...
	useEffect(() => {
		const fetchAlphaData = async () => {
			const url = `https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY_ADJUSTED&symbol=${selectedTicker}&apikey=HJK3F1Z8DFRH6C1Y`;
			try {
	...
	console.log('Most Recent Price:', mostRecentData);
