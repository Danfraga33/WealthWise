...
function QuizApp() {
	...
	const handleNextQuestion = () => {
		(selectedAnswer === quizData[currentQuiz].increase ? setScore(prevValue => prevValue + 750000) : selectedAnswer === quizData[currentQuiz].slightIncrease ? setScore(prevValue => prevValue + 250000) : selectedAnswer === quizData[currentQuiz].constant ? setScore(prevValue => prevValue + 0) : selectedAnswer === quizData[currentQuiz].slightDecrease ? setScore(prevValue => prevValue -250000))
