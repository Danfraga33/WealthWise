							...
							>
								{currentQuiz < quizData.length ? (
									<div className="quiz-question">
										...
										<button
											className="bg-purple-700 mb-5 text-white border-none block w-full cursor-pointer text-lg font-semibold py-3 hover:bg-purple-900 focus:outline-none focus:bg-brown-900 rounded-3xl "
