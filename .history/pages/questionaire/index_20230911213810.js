								...
								<div className="quiz-question">
									...
									<ul className="p-0 list-none">
										...
										>
											...
											<span className="ml-2">{quizData[currentQuiz].a}</span>
										</li>
										<li
											className="text-xl my-4"
										...
										>
											<input name="answer" type="radio" />
											<span className="ml-2">{quizData[currentQuiz].b}</span>
										</li>
										<li
											className="text-xl my-4"
										...
										>
											<input name="answer" type="radio" />
											<span className="ml-2">{quizData[currentQuiz].c}</span>
										</li>
										<li
											className="text-xl my-4"
										...
										>
											<input name="answer" type="radio" />
											<span className="ml-2">{quizData[currentQuiz].d}</span>
										</li>
									</ul>
									<button
										className="bg-purple-700 text-white border-none block w-full cursor-pointer text-lg font-semibold py-3 hover:bg-purple-900 focus:outline-none focus:bg-brown-900 rounded-3xl relative"
									...
									<Link href="/dashboard">
										<button className="text-center w-full absolute left-0 bottom-10">
											Go Back
										</button>
									</Link>
								</div>
