...
function QuizApp() {
	...
	const handleNextQuestion = () => {
		(selectedAnswer === quizData[currentQuiz].increase ? setScore(score + 750000) : selectedAnswer === quizData[currentQuiz].slightIncreaseincrease ? setScore(score + 250000) : selectedAnswer === quizData[currentQuiz].constant ? setScore(score + 0) : selectedAnswer === quizData[currentQuiz].slightDecrease ? setScore(score - 250000))
