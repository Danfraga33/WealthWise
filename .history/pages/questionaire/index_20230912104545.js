							...
							>
								{currentQuiz < quizData.length ? (
									...
									<div className="quiz-result">
										<p>
											Hey there, mom and dad investors! To achieve financial
											freedom, let's keep it simple. If you aim for a 5% return
											on your investments, you'd want to save up $2,500,000.
											That way, you can enjoy your retirement worry-free and
											with a big smile! Living this amazing lifestyle has an
											estimated annual cost of ${score * 0.05}
											<br />
											Assuming a dividend yield of 5%, you would need to
											accumulate ${score} to retire financailly free.
										</p>
