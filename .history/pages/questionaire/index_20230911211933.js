		...
		<>
			...
			<main className="box-border">
				<div className="bg-gradient-to-br from-blue-200 to-gray-100 font-poppins flex items-center justify-center h-screen m-0 overflow-hidden">
					<div className="bg-white rounded-lg shadow-md p-2 w-96 overflow-hidden">
						<div className="p-[4rem]">
							{currentQuiz < quizData.length ? (
								<div className="quiz-question">
									...
									<button
										className="bg-purple-700 text-white border-none block w-full cursor-pointer text-lg font-semibold py-3 hover:bg-purple-900 focus:outline-none focus:bg-brown-900"
