									...
									<div className="quiz-question">
										...
										<ul className="p-0 list-none">
											...
											>
												...
												<span className="ml-2"><label htmlFor="a">{quizData[currentQuiz].b}</span>
											</li>
											<li
												className="text-xl my-4"
											...
											>
												...
												<span className="ml-2"><label htmlFor="a">{quizData[currentQuiz].c}</span>
											</li>
											<li
												className="text-xl my-4"
											...
											>
												...
												<span className="ml-2"><label htmlFor="d">{quizData[currentQuiz].d}
												</label></span>
											</li>
										</ul>
										<button
