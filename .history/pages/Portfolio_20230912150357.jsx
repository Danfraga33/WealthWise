					...
					<div className="p-4">
						<div className="w-full border m-auto p-4 rounded-lg bg-white overflow-y-auto">
							...
							<div className="my-3 p-2 grid md:grid-cols-8 grid-cols-3 items-center justify-between cursor-pointer">
								...
								<span className="hidden mm:grid">Avg Purchase Price</span>
								<span className="hidden mm:grid">Value @ Purchase</span>
								<span className="hidden mm:grid">Last Price</span>
								<span className="hidden mm:grid">Market Value</span>
								<span className="hidden mm:grid">
