					...
					<form onSubmit={submitHandler}>
						...
						>
							...
							{suggestions.length > 0 && (
								<div className="absolute bg-white border border-gray-300 mt-8 w-[90%] rounded-lg shadow-lg z-10 h-full">
									<ul className="absolute bg-white border border-gray-300 mt-8 w-[90%] rounded-lg shadow-lg z-10 h-full">
