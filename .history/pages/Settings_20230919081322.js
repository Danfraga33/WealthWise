...
import { useCompoundContext } from '@/contextstore/DataContext';

const Settings = () => {
	const { sharedData, setSharedData } = useCompoundContext();
					...
					<div>
						...
						<div className="w-full">
							<div className="flex items-center w-full mb-2">
								...
								<input
									...
									className="border p-1 outline-none rounded-md w-full"
						...
						<div className="w-full ">
							<button
								...
								onClick={() => console.log(sharedData)}
							>
								Update
							</button>
						</div>
