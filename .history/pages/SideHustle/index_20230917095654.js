				...
				<div className="p-4 md:min-h-screen">
					<div className="md:grid md:grid-cols-3">
						<div className="col-span-2">
							<div className="md:p-8 md:bg-black rounded-lg">
								<div className="mb-4">
									<h2 className="text-white text-lg">Today's Progress</h2>
								</div>
								<div className="flex flex-col md:w-full gap-4 md:grid md:grid-cols-3 ">
									<Card
