	...
	return (
		<>
			<SideBar>
				<Header />
				<div className="p-4">
					<div className="md:grid md:grid-cols-4 md:grid-row-4 md:gap-8 grid grid-row-4">
						<div className="md:col-span-3 md:row-span-1 col-start-1 col-end-5">
							<SalesStats />
						</div>
						...
						<div className="md:col-start-4 md:col-end-5 md:row-start-4 md:row-end-5">
							<DonutChartComponent />
						</div>
					</div>
					<div className="mt-8">
