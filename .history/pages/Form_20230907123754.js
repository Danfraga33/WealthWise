...
const Form = (props) => {
	...
	function changingChecked() {
		checkbox.checked ? (checkbox.value = true) : false;
		setIsWatchListChecked(checkbox.value);
	}
	...
	async function submitHandler(event) {
		...
		const enteredWatchlist = watchlistInputRef.current.value;
		...
		const stock = {
			...
			valueAtPurchase: initialValue,
			lastPrice: enteredLastPrice,
			marketValue: marketValue,
			performance: performance,
			watchlist: isWatchlistChecked,
		};
		console.log(stock);
