					...
					<form onSubmit={submitHandler}>
						...
						>
							...
							{suggestions.length > 0 && (
								<ul className="absolute bg-white border border-gray-300 mt-8 w-[90%] rounded-lg shadow-lg z-10 h-full overflow-scroll">
										...
										>
											<div className="flex justify-between">
												<div className="flex flex-col">
													<div className="text-lg">{suggestion.ticker}</div>
													<div className="text-xs">{suggestion.name}</div>
												</div>
												<p className="mr-2">AUTOFILL</p>
											</div>
										</li>
									))}
								</ul>
