					...
					<form onSubmit={submitHandler}>
						...
						>
							...
							{suggestions.length > 0 && (
								<ul className="absolute bg-white border border-gray-300 mt-1 w-full rounded-lg shadow-md z-10">
									{suggestions.map((suggestion) => (
										<li
											key={suggestion.ticker}
											className="text-sm p-1 w-50% cursor-pointer hover:bg-gray-100"
											onClick={() => {
