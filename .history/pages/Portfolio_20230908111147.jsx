...
const Portfolio = ({ portfolioData }) => {
	...
	// 	console.log(GetData);
	// };
	console.log(portfolioData); //UNDEFINED

	useEffect(() => {
		// Fetch and update portfolioData here (e.g., using an API request)
		// You can use the same logic from your getStaticProps here
	...
	if (!portfolioData) {
		// Return some loading or error message here
...
export async function getStaticProps() {
	...
	return {
		props: {
			portfolioData: stockData.map((stock) => ({
				positionSize: stock.positionSize,
				avgPurchasePrice: stock.avgPurchasePrice,
				valueAtPurchase: stock.valueAtPurchase,
				lastPrice: stock.lastPrice,
