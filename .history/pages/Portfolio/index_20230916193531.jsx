											...
											<div className="sm:flex hidden justify-between items-center">
												...
												>
													<div>
														<button
															type="button"
															className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 no-pointer-events"
															onClick={(e) => {
																e.stopPropagation();
																// Handle the 3-dot button click here
															}}
														>
															<BsThreeDotsVertical />
														</button>
