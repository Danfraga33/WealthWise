									...
									<Link href={`/Portfolio/${stock.id}`} key={stock.id}>
										...
										>
											...
											<div className="sm:flex hidden justify-between items-center">
												...
												>
													<div>
														<Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 className="relative z-10"">
															<BsThreeDotsVertical
