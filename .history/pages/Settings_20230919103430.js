...
const settings = () => {
	...
	const [targetedAmount, settargetedAmount] = useState(null);
	const [annualGrowthRated, setannualGrowthRated] = useState(null);
	...
	console.log(
		calculatePeriodsToReachTarget(InitialAmount, TargetAmount, annualGrowthRate)
	);
